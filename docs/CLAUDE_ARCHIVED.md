...
> **ARCHIVED — May 2026.** Superseded by [CLAUDE.md](../CLAUDE.md) (agent pointer), [README.md](../README.md), and [IMPROVEMENT_PLAN.md](IMPROVEMENT_PLAN.md).  
> Much of Part 6 “Not Yet Done” is **out of date** (audio, menu, shop, terminals, docking all exist).
...
- Speed > 280 px/s equivalent (excitement) *(archived doc said 380; live cap is 280 — May 2026)*
