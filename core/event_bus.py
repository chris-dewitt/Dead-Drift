...
EVT_CORRIDOR_LAND   = "corridor_land"   # touchdown after real air; payload: impact vy
EVT_CORRIDOR_SKID   = "corridor_skid"   # direction-reversal skid at speed
EVT_CORRIDOR_SPRINT = "corridor_sprint" # sprint charge locked at full speed
EVT_CORRIDOR_CHIP   = "corridor_chip"   # chip collected; payload: chain (1-5)
EVT_CORRIDOR_TALLY  = "corridor_tally"  # tally screen row tick/stamp
EVT_CORRIDOR_STAR   = "corridor_star"   # star burst on the tally screen
EVT_CORRIDOR_SPRING = "corridor_spring" # bounce pad launch
EVT_CORRIDOR_BREAK  = "corridor_break"  # breakable block shattered at sprint
EVT_CORRIDOR_QBLOCK = "corridor_qblock" # ?-block bonked; payload: contains
EVT_CORRIDOR_PIPE   = "corridor_pipe"   # warp pipe taken
EVT_CORRIDOR_POWERUP   = "corridor_powerup"    # payload: kind
EVT_CORRIDOR_POWERDOWN = "corridor_powerdown"  # power expired / hardhat spent
